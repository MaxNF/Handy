...
//todo сделать меню О программе с предложением доната
//todo сделать поп-ап спустя определенное кол-во запусков о донате
...
//todo сделать кнопку Начать больше, чтобы влазил весь текст (в приветствии)
//todo если приложению не выдано разрешение на отслеживания местоположения, то после того как человек разрешает, сразу открывать фрагмент с геозонами
