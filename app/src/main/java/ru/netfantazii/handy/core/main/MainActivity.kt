...
//todo сделать запрет на покупки подписки незалогиненым пользователям. Присваивать подписку текущему аккаунту.

//todo сделать диплинки на меню настройки подписок. Если у пользователя есть подписка на приложение - https://play.google.com/store/account/subscriptions?sku=your-sub-product-id&package=your-app-package если нет то https://play.google.com/store/account/subscriptions
//todo сделать механизм продления подписки
//todo в определенные моменты окончания подписки нужно предложить пользователю возобновить подписку, отправлять емеил

//todo сделать в помощи кнопочку F.A.Q. и разъяснить там возможные проблемы и решения с подпиской
