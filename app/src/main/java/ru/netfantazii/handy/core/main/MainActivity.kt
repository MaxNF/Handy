...
//todo исправить баг у оверлея каталогов (не сбрасывается результат переименования при отмене)
//todo добавить пояснение в раздел помощи, что поиск по карте осуществляется в видимых границах и он не автоматизирован
